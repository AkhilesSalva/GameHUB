...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .nav-links a:hover { color: white; border-bottom-color: #4CAF50; }
        ...
        /* ========================================================================= */
        /* 3. PAGE CONTENT & CARDS (EFEK HOVER BARU) */
        /* ========================================================================= */
        .page-header { margin-bottom: 25px; border-bottom: 3px solid #2a3c58; padding-bottom: 10px; }
        ...
        .game-grid { 
            ...
            gap: 25px; 
            margin-top: 20px; /* Tambah jarak dari header */
        }
        ...
        .game-card { 
            ...
            border-radius: 8px; 
            overflow: hidden; 
            transition: transform 0.3s, box-shadow 0.3s; /* Tambah transisi box-shadow */
        }
        .game-card:hover { 
            transform: translateY(-8px); /* Mengangkat kartu */
            box-shadow: 0 10px 20px rgba(0, 0, 0, 0.5); /* Tambah shadow saat terangkat */
        }
...
<body>
    ...
    <div class="store-container">
        <div class="page-header">
            <h1>Genre: <span><?php echo htmlspecialchars($genre_nama); ?></span></h1>
            <p style="color: #b0b0b0; margin-top: 10px;">Menampilkan semua game dalam kategori **<?php echo htmlspecialchars($genre_nama); ?>**.</p>
        </div>
        ...
        <div class="game-grid">
            <?php if ($games_result && mysqli_num_rows($games_result) > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p class="empty-state">Tidak ada game yang ditemukan dalam genre **<?php echo htmlspecialchars($genre_nama); ?>**.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        // Hapus fungsi hideLoader karena tidak ada loading-overlay di sini
    </script>
</body>
</html>